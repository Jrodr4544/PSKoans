...
Describe 'Arithmetic Operators' {
    ...
    Context 'Subtraction' {
        ...
        It 'cannot be used with strings' {
            ...
            { @(1, 2) - 1 } | Should -Throw -ExpectedMessage 'does not contain a method named ''op_Subtraction'''
        }
    }
    ...
    Context 'Division' {
        ...
        It 'is restricted to numeric use only' {
            ...
            #>
            { 'hello!' / 3 } | Should -Throw -ExpectedMessage 'Cannot convert value "hello!" to type "System.Int32"'
    ...
    Context 'Modulus' {
        <#
                Mdulus is a bit of an odd one, but common enough in programming. It performs a
        ...
        It 'cannot be used on non-numeric values' {
            ...
            $ModulusOnString | Should -Throw -ExpectedMessage 'Cannot convert value "hello!" to type "System.Int32"'
            ...
            $ModulusOnArray | Should -Throw -ExpectedMessage 'Method invocation failed because [System.Object[]] does not contain a method named ''op_Modulus'''
        }
    }
}
