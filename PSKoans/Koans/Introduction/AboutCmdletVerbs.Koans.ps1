...
Describe "Basic Verbs" {
    ...
    Context "Add" {
        ...
        It 'is for commands that append data' {
            ...
            #>
            $Answers = "Add-AppPackage", "Add-AppPackageVolume", "Add-AssertionOperator", "Add-ShouldOperator", "Add-MpPreference"
        ...
        It 'can Add-Content to a file' {
            ...
            'Random' | Add-Content -Path $FilePath
            'Test' | Add-Content -Path $FilePath
            'adding' | Add-Content -Path $FilePath
    ...
    Context "Set" {
        ...
        It 'is for commands that overwrite data' {
            ...
            #>
            $Answers = "Set-Service", "Set-Timezone", "Set-TraceSource", "Set-Variable", "Set-WindowsEdition"
    ...
    Context "Remove" {
        ...
        #>
            $Answers = "Remove-Computer", "Remove-Event", "Remove-Item", "Remove-Job", "Remove-Module"
